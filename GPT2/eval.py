...
def main():
    ...
    parser.add_argument('--raw_data_path', default='data/poetfinish.json', type=str, required=False, help='原始语料')
    ...
    parser.add_argument('--pretrained_model', default='model/model_epoch100', type=str, required=False, help='模型起点路径')
